...
* 2015/04/19: [#28](https://github.com/andrewvy/slack-pongbot/pull/28) - Accept both challenge `single` and `singles`, `double` and `doubles` - [@dblock](https://github.com/dblock).
